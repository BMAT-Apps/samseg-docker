...
class SamSegWorker(QObject):
    ...
    def __init__(self, bids, add_info, subjects_and_sessions, mprage=False, flair=False, normalization=False, preprocessing=True):
        ...
        self.freesurfer_license = pjoin(os.getcwd(),'Pipelines','samseg-docker','license.txt')
            ...
            for ses in sess:
                ...
                if self.preprocessing: 
                    ...
                    if self.normalization:
                        ...
                        if self.flair:    
                            ...
                            try:
                                ...
                                subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_directory}:/media/sub_ses_directory -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo freesurfer/freesurfer:7.2.0 recon-all -motioncor -i /media/sub_ses_directory/{flair} -subjid sub-{self.sub}_ses-{self.ses}_FLAIR_preprocessed -sd /media/sub_ses_derivative_path_transfo', shell=True).wait()
                            ...
                            try:
                                ...
                                subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo freesurfer/freesurfer:7.2.0 mri_convert /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_preprocessed/mri/orig.mgz /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_preprocessed.nii.gz', shell=True).wait()           
                        ...
                        if self.mprage:    
                            ...
                            try:
                                ...
                                subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_directory}:/media/sub_ses_directory -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo freesurfer/freesurfer:7.2.0 recon-all -motioncor -i /media/sub_ses_directory/{mprage} -subjid sub-{self.sub}_ses-{self.ses}_MPRAGE_preprocessed -sd /media/sub_ses_derivative_path_transfo', shell=True).wait()
                            ...
                            try:
                                ...
                                subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo freesurfer/freesurfer:7.2.0 mri_convert /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_MPRAGE_preprocessed/mri/orig.mgz /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_MPRAGE_preprocessed.nii.gz', shell=True).wait()           
                    ...
                    if self.mprage and self.flair:
                        ...
                        try:
                            ...
                            subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo freesurfer/freesurfer:7.2.0 mri_coreg --mov /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_preprocessed.nii.gz --ref /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_MPRAGE_preprocessed.nii.gz --reg /media/sub_ses_derivative_path_transfo/flairToT1.lta', shell=True).wait()      
                            subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo freesurfer/freesurfer:7.2.0 mri_vol2vol --mov /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_preprocessed.nii.gz --reg /media/sub_ses_derivative_path_transfo/flairToT1.lta --o /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_registered.nii.gz --targ /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_MPRAGE_preprocessed.nii.gz', shell=True).wait()                                  
                ...
                if self.mprage and self.flair:
                    ...
                    try:
                        ...
                        subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo freesurfer/freesurfer:7.2.0 mri_convert /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_registered.nii.gz /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_registered.mgz', shell=True).wait()
                        ...
                        subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo -v {sub_ses_derivative_path_segment}:/media/sub_ses_derivative_path_segment freesurfer/freesurfer:7.2.0 run_samseg -i /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_MPRAGE_preprocessed.mgz -i /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_registered.mgz --lesion --lesion-mask-pattern 0 1 --threads 4 -o /media/sub_ses_derivative_path_segment/SAMSEG_results --save-posteriors', shell=True).wait()
                        ...
                        subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_derivative_path_segment}:/media/sub_ses_derivative_path_segment freesurfer/freesurfer:7.2.0 mri_convert /media/sub_ses_derivative_path_segment/SAMSEG_results/posteriors/Lesions.mgz /media/sub_ses_derivative_path_segment/sub-{self.sub}_ses-{self.ses}_lesions.nii.gz', shell=True).wait()
                ...
                ## Run SAMSEG with only FLAIR 
                    ...
                    if self.flair:
                        ...
                        try:
                            ...
                            subprocess.Popen(f'docker run --rm --privileged -v {self.freesurfer_license}:/usr/local/freesurfer/license.txt -v {sub_ses_derivative_path_transfo}:/media/sub_ses_derivative_path_transfo -v {sub_ses_derivative_path_segment}:/media/sub_ses_derivative_path_segment freesurfer/freesurfer:7.2.0 run_samseg -i /media/sub_ses_derivative_path_transfo/sub-{self.sub}_ses-{self.ses}_FLAIR_preprocessed.mgz --lesion --lesion-mask-pattern 0 --threads 4 -o /media/sub_ses_derivative_path_segment/SAMSEG_results --save-posteriors', shell=True).wait()
